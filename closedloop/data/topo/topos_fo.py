...
def compute_topographies(subject, night, swori_fname, areas):
    """_summary_
    ...
    sbj_dir = op.join(data_dir, 'mne', subject)
    ...
    ltc_dir = op.join(sbj_dir, night, 'ltc')
    ...
    for _aw in aw:
        ...
        epo_fname = op.join(sbj_dir, night, 'epo', _aw, 
        ...
        raw_fname = op.join(sbj_dir, night, 'raw', _aw, 
                            f'{subject}_{night}-raw.fif')
    ...
    raw_info = {'sfreq': raw_epo.info['sfreq'], 
    ...
    epo_info = {'sfreq': epochs.info['sfreq'], 
