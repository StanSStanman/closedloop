        ...
        if n_samp != 0:
            ...
            for t in self.trig_unique:
                if t in samp_data:
                    ...
                    self.delays_pos.append(np.where(samp_data==t)[0])
...
if __name__ == "__main__":
    ...
    delays_df.to_csv('/home/phantasos/Scrivania/lsl_tests/test_3.csv')
    d_pos = np.hstack(d_pos)
    d_pos_df = pd.DataFrame(d_pos, columns=['trig_idx'])
    d_pos_df.to_csv('/home/phantasos/Scrivania/lsl_tests/test_idx_3.csv')
